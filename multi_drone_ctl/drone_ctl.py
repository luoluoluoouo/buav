...
class OffboardControl(Node):
    ...
    def __init__(self) -> None:
        ...
        self.vehicle_status_subscriber = self.create_subscription(
            VehicleStatus, prefix + '/fmu/out/vehicle_status_v1', self.vehicle_status_callback, qos_profile)
    ...
    def timer_callback(self) -> None:
        ...
        # self.get_logger().warn(f"vehicle_status.nav_state {self.vehicle_status.nav_state}")
        # self.get_logger().warn(f"NAVIGATION_STATE_OFFBOARD {VehicleStatus.NAVIGATION_STATE_OFFBOARD}")
